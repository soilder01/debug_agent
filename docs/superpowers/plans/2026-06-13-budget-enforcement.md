...
- Surface whether hard budget enforcement is enabled in observability summary and UI.
...
- RED: observability API/UI tests fail because hard enforcement visibility is missing.
